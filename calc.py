...
for cappcodd in range(len(capcodd)):capcob = __import__("turtle").Turtle();capcob.hideturtle();capcob.penup();capcob.goto(capcodd[cappcodd][0], capcodd[cappcodd][1] - 10);capcob.write(capcodd[cappcodd][3], align="center", font=("Arial", 16, "bold")) # fait quelque chose
